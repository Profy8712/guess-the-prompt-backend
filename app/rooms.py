...
class Player:
    def __init__(self, name: str, role: str = "user", user_id: Optional[int] = None):
        ...
        self.prompt_submitted = False  # <--- добавлено!
...
class Room:
    def __init__(self, room_id: str):
        ...
        self.current_turn = 0
        self.round_number = 1
        self.round_count = 5      # default, можно изменить
        self.prompt_words = 1     # default, можно изменить
        self.turn_length = 60     # default, можно изменить
